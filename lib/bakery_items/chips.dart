                                  ...
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Tostitos Oven Baked Scoops.jpg'),
                                        fit: BoxFit.cover)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Tostitos Oven Baked\nScoops", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                ...
                                Container(
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: Colors.grey,
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Popchips Potato Chips, Sea Salt.jpg'),
                                        fit: BoxFit.cover)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Popchips Potato Chips,\nSea Salt", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                                  Icon(EvaIcons.heartOutline, color: Colors.black12),
                                                ],
                                              ),
                                            ),
                                ...
                                Container(
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: Colors.grey,
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Ruffles, Oven Baked Cheddar & Sour Cream.jpg'),
                                        fit: BoxFit.cover)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Ruffles Sour Cream", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                                  Icon(EvaIcons.heartOutline, color: Colors.black12),
                                                ],
                                              ),
                                            ),
