...
class MilkShake extends StatefulWidget {
  @override
  _MilkShakeState createState() => _MilkShakeState();
}
                                  ...
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Chocolate Hazelnut Milkshake.webp'),
                                        fit: BoxFit.fill)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Chocolate Hazelnut\nMilkshake", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                ...
                                Container(
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: Colors.grey,
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Chocolate Malt Milkshake.jpg'),
                                        fit: BoxFit.fill)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Chocolate Malt Milkshake", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                                  Icon(EvaIcons.heartOutline, color: Colors.black12),
                                                ],
                                              ),
                                            ),
                                ...
                                Container(
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: Colors.grey,
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Date Milkshake.jpg'),
                                        fit: BoxFit.fill)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Date Milkshake", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                                  Icon(EvaIcons.heartOutline, color: Colors.black12),
                                                ],
                                              ),
                                            ),
