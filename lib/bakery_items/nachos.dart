...
class Nachos extends StatefulWidget {
  @override
  _NachosState createState() => _NachosState();
}

class _NachosState extends State<Nachos> {
  @override
                                  ...
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Nachos-LEAD.jpg'),
                                        fit: BoxFit.fill)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Nachos with cheese", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Nachos with tomate", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                                  Icon(EvaIcons.heartOutline, color: Colors.black12),
                                                ],
                                              ),
                                            ),
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Nachos Red Chill", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                                  Icon(EvaIcons.heartOutline, color: Colors.black12),
                                                ],
                                              ),
                                            ),
