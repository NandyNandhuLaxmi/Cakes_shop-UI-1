...
class Popcorn extends StatefulWidget {
  @override
  _PopcornState createState() => _PopcornState();
}
                                  ...
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Aged-White-Cheddar.jpg'),
                                        fit: BoxFit.fill)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Aged-White-Cheddar", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                ...
                                Container(
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: Colors.grey,
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Apple-Cinnamon-Crunch.jpg'),
                                        fit: BoxFit.fill)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Apple-Cinnamon-Crunch", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                                  Icon(EvaIcons.heartOutline, color: Colors.black12),
                                                ],
                                              ),
                                            ),
                                ...
                                Container(
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: Colors.grey,
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Bacon-y-Cheddar-Ranch.jpg'),
                                        fit: BoxFit.fill)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Bacon-y-Cheddar-Ranch", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                                  Icon(EvaIcons.heartOutline, color: Colors.black12),
                                                ],
                                              ),
                                            ),
