...
class Puffs extends StatefulWidget {
  @override
  _PuffsState createState() => _PuffsState();
}

class _PuffsState extends State<Puffs> {
  @override
                                  ...
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Spinach-Puffs-2.jpg'),
                                        fit: BoxFit.fill)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Spinach Puffs Recipe", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                ...
                                Container(
                                  margin: EdgeInsets.only(right: 8, left: 8, top: 8, bottom: 8),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: Colors.grey,
                                      image: DecorationImage(
                                        image: AssetImage('Assets/images/Easy-Spinach-Puffs.jpg'),
                                        fit: BoxFit.fill)),
                                ),
                                Expanded(
                                  child: Container(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Spinach Puffs", maxLines: 2, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
                                                  Icon(EvaIcons.heartOutline, color: Colors.black12),
                                                ],
                                              ),
                                            ),
